...
public class GameForTwoController implements Game{
    ...
    private void startNewCircle() {
        ...
        if(currentCard.color != Color.ALL){
            ...
            switch (currentCard.mark){
                case TURN: break;
                case PT: players.get(1).takeTwoCards(); break;
                case PF: players.get(1).takeFourCards(); break;
                case PASS: break;
                default: p1Move();
            }
